...
// 1. Tipe Data untuk Rincian Item Unit
...
export default function NegotiablePriceToCustomers() {
      ...
      const response = await fetch(
        `${API_CONFIG.BASE_URL}/public/v1/tenders/store`,
        {
          ...
          body: JSON.stringify({
            ...
            request_by: "marketing",
            marketing_price: hargaNegoBaru,
            marketing_note: catatanBaru,
            customer_price: null,
            customer_note: null,
            deal_price: null,
  ...
  // Hitung total nilai unit saat ini
                  ...
                  <div className="grid grid-cols-2 sm:flex gap-2 w-full sm:w-auto shrink-0">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        setTimeout(() => { router.push("/dashboard/crm/uploads-document"); }, 3000);
                      }}
