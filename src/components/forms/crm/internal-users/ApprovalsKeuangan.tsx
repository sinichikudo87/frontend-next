...
export default function ApprovalsKeuangan() {
  ...
  const [berkasList, setBerkasList] = useState<BerkasItem[]>([
    {
      id: 1,
      namaDokumen: "Divisi Keuangan - Form Approval",
    ...
    const fetchData = async () => {
      try {
        ...
        Swal.fire({
          ...
          text: "Data approval tidak ditemukan atau sudah expired",
          background: "#0f172a",
          color: "#fff",
  ...
  if (!approvalDetail) {
    return (
      <div className="min-h-screen flex flex-col gap-4 items-center justify-center text-white bg-slate-950 relative overflow-hidden px-4">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-emerald-500/10 rounded-full blur-[100px]" />
        <div className="relative flex items-center justify-center h-14 w-14">
          <div className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></div>
          <div className="relative inline-flex rounded-full h-10 w-10 bg-gradient-to-tr from-emerald-600 to-teal-500 shadow-lg"></div>
        </div>
  ...
  const handleSubmitSelesai = async (e: React.FormEvent) => {
      ...
      try {
        ...
        const payload = {
          ...
          approval_role: "admin_keuangan" as const,
          approver_id: 1,
  ...
  *${finalStatus.toUpperCase()}*
  ...
  /* ================= UI RENDERING ================= */
  return (
    <div className="min-h-screen w-full bg-slate-950 text-slate-100 p-3 sm:p-6 md:p-8 relative overflow-x-hidden selection:bg-emerald-500/30">
      ...
      <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6 relative z-10">
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl p-4 sm:p-6 md:p-8 shadow-xl space-y-5">
          ...
          <div className="space-y-2.5">
            ...
            {/* TAMPILAN MOBILE: Berubah jadi Card List modern */}
            ...
            {/* TAMPILAN DESKTOP: Tabel Tradisional Mewah */}
          ...
          {/* SUMMARY TOTAL CASH */}
          <div className="flex justify-between sm:justify-end items-center bg-gradient-to-r from-emerald-500/[0.02] to-emerald-500/[0.06] p-3 sm:p-4 rounded-xl border border-emerald-500/10">
            <div className="flex items-center gap-2 text-emerald-400 text-xs font-semibold uppercase tracking-wider sm:hidden">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-2.5 text-slate-200">
                  <Coins className={`w-4 h-4 mt-0.5 flex-shrink-0 ${isApproved ? 'text-emerald-400' : isRejected ? 'text-red-400' : 'text-emerald-400'}`} />
                  <div className="w-full">
                    <span className="text-[10px] text-slate-400 block font-medium uppercase tracking-wider">Verifikasi Keuangan</span>
                ...
                {isRejected && (
                  <div className="space-y-1.5 pt-1">
                    ...
                    <textarea
                      ...
                      placeholder="Sebutkan alasan penolakan atau revisi anggaran dana..."
                      rows={3}
