...
interface HRDClientProps {
  attendanceData: { month: string; value: number }[];
  employeeData: { name: string; value: number }[];
  summary: {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black">HRD Dashboard</h1>
        ...
        <div className="hidden md:flex items-center gap-2 px-4 py-2 rounded-2xl bg-white/5 border border-white/10">
          ...
          <span className="text-sm text-white/70">
            Employee Growth {summary.growth}
          </span>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <p className="text-slate-400 text-sm mt-5">Total Employees</p>
          <h2 className="text-4xl font-black mt-2">{summary.totalEmployees}</h2>
        ...
        >
          ...
          <p className="text-slate-400 text-sm mt-5">Attendance</p>
          <h2 className="text-4xl font-black mt-2">{summary.attendanceRate}</h2>
          <span className="text-cyan-400 text-xs">Stable performance</span>
        </motion.div>
        ...
        >
          ...
          <p className="text-slate-400 text-sm mt-5">Departments</p>
          <h2 className="text-4xl font-black mt-2">{summary.totalDepartments}</h2>
          <span className="text-fuchsia-400 text-xs">Active divisions</span>
        </motion.div>
        ...
        >
          ...
          <p className="text-slate-400 text-sm mt-5">Performance</p>
          <h2 className="text-4xl font-black mt-2">{summary.performanceRate}</h2>
          <span className="text-pink-400 text-xs">Above target</span>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        <div className="xl:col-span-2 rounded-3xl border border-white/10 bg-white/[0.05] p-6 backdrop-blur-2xl transition-all duration-300 hover:shadow-2xl hover:shadow-fuchsia-500/10">
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-400">Monthly employee attendance statistics</p>
          </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.05] p-6 backdrop-blur-2xl transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/10">
          <div className="mb-6">
            <h2 className="text-xl font-bold text-white">Employee Distribution</h2>
            <p className="text-sm text-slate-400">Employee percentage by division</p>
          </div>
