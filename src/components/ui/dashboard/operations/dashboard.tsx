...
// Tipe data untuk props yang dikirim dari Server
interface OperationsContentProps {
  operationsData: Array<{ month: string; value: number }>;
  opsStatusData: Array<{ name: string; value: number }>;
}
...
export default function OperationsContent({ operationsData, opsStatusData }: OperationsContentProps) {
  return (
    <motion.div
      initial="hidden"
      animate="show"
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-slate-400 text-sm mt-5">Total Operations</p>
          <h2 className="text-4xl font-black mt-2">128</h2>
          <span className="text-emerald-400 text-xs">+14 this month</span>
        </motion.div>
        ...
        >
          ...
          <h2 className="text-4xl font-black mt-2">86</h2>
          <span className="text-cyan-400 text-xs">Smooth workflow</span>
        </motion.div>
        ...
        >
          ...
          <p className="text-slate-400 text-sm mt-5">In Progress</p>
          <h2 className="text-4xl font-black mt-2">34</h2>
          <span className="text-fuchsia-400 text-xs">Ongoing tasks</span>
        </motion.div>
        ...
        >
          ...
          <p className="text-slate-400 text-sm mt-5">Efficiency Rate</p>
          <h2 className="text-4xl font-black mt-2">90%</h2>
          <span className="text-pink-400 text-xs">High productivity</span>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.05] p-6 backdrop-blur-2xl transition-all duration-300 hover:shadow-2xl hover:shadow-fuchsia-500/10">
          <div className="mb-6">
            <h2 className="text-xl font-bold text-white">Operations Status</h2>
            <p className="text-sm text-slate-400">Task distribution</p>
          </div>
